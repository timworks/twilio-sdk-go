...
// BindingsPageResponse defines the response fields for the bindings page
type BindingsPageResponse struct {
	Bindings []PageBindingResponse `json:"bindings"`
	Meta     PageMetaResponse      `json:"meta"`
}

// Page retrieves a page of bindings
// See https://www.twilio.com/docs/chat/rest/binding-resource#read-multiple-binding-resources for more details
// Context is defaulted to Background. See https://golang.org/pkg/context/#Background for more information
func (c Client) Page(options *BindingsPageOptions) (*BindingsPageResponse, error) {
	return c.PageWithContext(context.Background(), options)
}

// PageWithContext retrieves a page of bindings
// See https://www.twilio.com/docs/chat/rest/binding-resource#read-multiple-binding-resources for more details
