...
// Page retrieves a page of asset versions
// See https://www.twilio.com/docs/runtime/functions-assets-api/api/asset-version#read-multiple-assetversion-resources for more details
// Context is defaulted to Background. See https://golang.org/pkg/context/#Background for more information
func (c Client) Page(options *VersionsPageOptions) (*VersionsPageResponse, error) {
	return c.PageWithContext(context.Background(), options)
}

// PageWithContext retrieves a page of asset versions
// See https://www.twilio.com/docs/runtime/functions-assets-api/api/asset-version#read-multiple-assetversion-resources for more details
...
func (c *Client) NewVersionsPaginatorWithOptions(options *VersionsPageOptions) *VersionsPaginator {
	return &VersionsPaginator{
		...
		Versions: make([]PageAssetVersionResponse, 0),
	}
}

// VersionsPage defines the fields for the page
// The CurrentPage and Error fields can be used to access the PageAssetVersionResponse or error that is returned from the api call(s)
