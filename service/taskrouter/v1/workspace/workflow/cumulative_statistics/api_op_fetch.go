...
// See https://www.twilio.com/docs/taskrouter/api/workflow-statistics#workflow-cumulative-statistics for more details
...
func (c Client) FetchWithContext(context context.Context, options *FetchCumulativeStatisticsOptions) (*FetchCumulativeStatisticsResponse, error) {
	op := client.Operation{
		...
		URI:    "/Workspaces/{workspaceSid}/Workflows/{workflowSid}/CumulativeStatistics",
