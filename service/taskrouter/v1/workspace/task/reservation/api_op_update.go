...
// Update modifies a task reservation resource
// See https://www.twilio.com/docs/taskrouter/api/reservations#action-update for more details
// Context is defaulted to Background. See https://golang.org/pkg/context/#Background for more information
func (c Client) Update(input *UpdateReservationInput) (*UpdateReservationResponse, error) {
	return c.UpdateWithContext(context.Background(), input)
}

// UpdateWithContext modifies a task reservation resource
// See https://www.twilio.com/docs/taskrouter/api/reservations#action-update for more details
