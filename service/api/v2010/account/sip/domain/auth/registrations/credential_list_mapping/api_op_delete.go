...
// See https://www.twilio.com/docs/voice/sip/api/sip-domain-registration-credentiallistmapping-resource#delete-a-sip-domain-registration-credentiallistmapping-resource for more details
