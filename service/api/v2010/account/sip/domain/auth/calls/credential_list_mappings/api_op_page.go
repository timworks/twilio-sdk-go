...
// See https://www.twilio.com/docs/voice/sip/api/sip-credentiallistmapping-resource#read-multiple-sip-credentiallistmapping-resources for more details
...
func (c Client) PageWithContext(context context.Context, options *CredentialListMappingsPageOptions) (*CredentialListMappingsPageResponse, error) {
	op := client.Operation{
		...
		URI:    "/Accounts/{accountSid}/SIP/Domains/{domainSid}/Auth/Calls/CredentialListMappings.json",
