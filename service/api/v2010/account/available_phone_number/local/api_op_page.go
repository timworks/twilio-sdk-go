...
// Page retrieves a page of available local phone numbers
// See https://www.twilio.com/docs/phone-numbers/api/availablephonenumberlocal-resource#read-multiple-availablephonenumberlocal-resources for more details
...
// PageWithContext retrieves a page of available local phone numbers
// See https://www.twilio.com/docs/phone-numbers/api/availablephonenumberlocal-resource#read-multiple-availablephonenumberlocal-resources for more details
func (c Client) PageWithContext(context context.Context, options *AvailablePhoneNumbersPageOptions) (*AvailablePhoneNumbersPageResponse, error) {
	op := client.Operation{
		...
		URI:    "/Accounts/{accountSid}/AvailablePhoneNumbers/{countryCode}/Local.json",
